...
const RetroNavbar = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className={`fixed inset-0 flex items-center justify-center z-50 transition-all duration-300 bg-black/20 backdrop-blur-md ${isOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
    >
      <div className="scanlines absolute inset-0 pointer-events-none opacity-20"></div>

      <div className="relative max-w-4xl w-full mx-4">
        <div className="relative">
          <svg className="absolute -top-1 -left-1 -right-1 -bottom-1 w-[calc(100%+8px)] h-[calc(100%+8px)]" viewBox="0 0 100 100" preserveAspectRatio="none">
            <path
          ...
          <div
            ...
            style={{
              ...
              clipPath: "polygon(0% 12%, 3% 0%, 97% 0%, 100% 12%, 100% 88%, 97% 100%, 3% 100%, 0% 88%)",
          ...
          >
              ...
              <div className="flex justify-between items-center">
                ...
                >
                  <svg className="absolute inset-0 w-full h-full" viewBox="0 0 40 40">
                    <path d="M5,10 L2,13 V27 L5,30 H35 L38,27 V13 L35,10 H5"
                      fill="none"
                  ...
                  <svg className="w-6 h-6 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M18 6L6 18M6 6L18 18" stroke={colors.accent} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </button>
              </div>
            </div>
                      ...
                      <div className="relative">
                        ...
                        >
                          <path
                            ...
                            fill={isActive ? `rgba(94, 234, 212, 0.12)` : (isHovered ? `rgba(94, 234, 212, 0.08)` : 'transparent')}
                            stroke={isActive ? colors.accent : colors.borderDark}
                        ...
                        >
                          <div className="flex items-center">
                            <span
                              ...
                              style={{
                                color: isActive ? colors.accent : colors.accentDim,
                                opacity: isActive ? 1 : 0.8
                              }}
                            >
                              [{link.id === '/' ? 'H' : link.id.charAt(1).toUpperCase()}]
                            </span>
                            <span
                              style={{
                                fontFamily: "'Press Start 2P', 'Space Mono', monospace",
                                ...
                                textShadow: isActive ? `0 0 5px ${colors.accent}60` : 'none'
                              }}
                            >
                              {link.label}
                            </span>
            ...
            >
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                >
                  <span style={{ color: colors.accent }}>[INFO]</span> SELECT DESTINATION TO PROCEED
                </p>

                <div className="flex items-center gap-3">
                  {[{ name: 'Linkedin', link: 'https://www.linkedin.com/company/gecintensa/about/' }, { name: 'Instagram', link: 'https://www.instagram.com/intensa_techfluence2025/' }].map((social) => (
