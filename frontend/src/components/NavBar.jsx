...
const Navbar = () => {
  ...
  return (
    <nav className="w-full  py-4 px-6 absolute top-2 left-0 right-0 z-50 mt-8">
      <div className="flex justify-end md:justify-center items-center max-w-6xl mx-auto">
        <button
          className="md:hidden text-white focus:outline-none pr-12 pt-1"
        ...
        <div className="hidden md:flex space-x-8 place-self-center">
          {links.map((item, index) => (
            <button
              ...
              className="font-['Press_Start_2P'] text-white text-lg tracking-wide hover:text-white"
            >
              {item.text}
            </button>
          ))}
